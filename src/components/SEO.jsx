...
const SEO_CONFIG = {
  '/': {
    title: `${SCHOOL_NAME} - الصفحة الرئيسية | مدرسة خاصة في عجمان`,
    description: 'مدرسة الحكمة الخاصة في عجمان، الإمارات العربية المتحدة. تقدم تعليماً متميزاً من الروضة حتى الثانوية للبنين والبنات. سجل الآن للعام الدراسي 2025-2026.',
    keywords: 'مدرسة خاصة، مدرسة في عجمان، مدارس خاصة في الإمارات، تعليم خاص، تسجيل مدرسة، مدرسة روضة، مدرسة ابتدائية، مدرسة ثانوية',
  ...
  '/branches': {
    ...
    description: 'اكتشف فروع مدرسة الحكمة الأربعة في عجمان: النعيمية، التلة، الجرف، ومصفوت. مرافق تعليمية حديثة ومعلمون متخصصون في جميع الفروع.',
    keywords: 'فروع المدرسة، مدرسة في النعيمية، مدرسة في التلة، مدرسة في الجرف، مدرسة في مصفوت، مدارس في عجمان، موقع المدرسة',
  ...
  '/careers': {
    ...
    keywords: 'وظائف في المدارس، معلمين، وظائف تعليمية، عمل في الإمارات، وظائف مدرسية، سيرة ذاتية، تقديم وظيفة، وظائف في عجمان',
    ogImage: '/images/body/student.png',
  },
  '/kindergarten': {
    ...
    keywords: 'روضة أطفال، تعليم الروضة، حضانة، رياض أطفال، مرحلة ما قبل المدرسة، تسجيل الروضة، مدرسة روضة في عجمان',
  ...
  '/elementary': {
    ...
    keywords: 'المرحلة الابتدائية، الصف الابتدائي، تعليم ابتدائي، مدرسة ابتدائية، صف أول، مدارس ابتدائية في عجمان',
  ...
  '/highschool-boys': {
    ...
    keywords: 'ثانوية بنين، مدرسة ثانوية للبنين، تعليم ثانوي، صف ثانوي، إعداد الجامعة، مدرسة ثانوية في عجمان',
